...
#a função de reortar ja esta no codigo  @draw weighted values.
        ...
        for i in range(len(msg.ranges)):
            ...
            for p in self.particle_cloud:
                for z in msg.ranges:
                    ...
                    y=p.y+l*math.sin(math.radians(i))
    ...
    def update_initial_pose(self, msg):
        ...
        for i in range(self.n_particles):
            ...
            p.w = 1.0/self.n_particles #probabilidade da particula
    ...
    def fix_map_to_odom_transform(self, msg):
        ...
        p = PoseStamped(pose=convert_translation_rotation_to_pose(translation,rotation), header=Header(stamp=rospy.Time(0),frame_id=self.base_frame))
